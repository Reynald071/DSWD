		...
		<div class="row">
			<div class="col-lg-7 col-md-5 align-self-center text-md-right text-center">
			  	<?php if ( get_theme_mod('lms_education_phone_number') ) : ?>
			    	<span><span class="dashicons dashicons-<?php echo esc_attr( $icon1 ); ?>"></span><a href="callto:<?php echo esc_html(get_theme_mod('lms_education_phone_number','')); ?>"><?php echo esc_html(get_theme_mod('lms_education_phone_number','')); ?></a></span>
			  	<?php endif; ?>

			  	<?php if ( get_theme_mod('lms_education_email_address') ) : ?>
			    	<span><span class="dashicons dashicons-<?php echo esc_attr( $icon2 ); ?>"></span><a href="mailto:<?php echo esc_html(get_theme_mod('lms_education_email_address','')); ?>"><?php echo esc_html(get_theme_mod('lms_education_email_address','')); ?></a></span>
			  	<?php endif; ?>
			</div>
