        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-3 col-sm-3 align-self-center text-md-right">
                <?php if(get_theme_mod('online_tutor_phone_number') != ''){ ?>
                    <a class="contact" href="tel:<?php echo esc_html(get_theme_mod('online_tutor_phone_number','')); ?>"><span><?php echo esc_html(get_theme_mod('online_tutor_phone_number','')); ?></span></a><span>|</span>
                <?php }?>
                <?php if(get_theme_mod('online_tutor_email') != ''){ ?>
                    <a class="mail" href="mailto:<?php echo esc_html(get_theme_mod('online_tutor_email','')); ?>"><span><?php echo esc_html(get_theme_mod('online_tutor_email','')); ?></span></a>
                <?php }?>
            </div>
        </div>
    </div>
