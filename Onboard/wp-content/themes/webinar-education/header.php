...
<?php if ( get_theme_mod('lms_education_site_loader', false) == true ) : ?>
	<div class="cssloader">
    	<div class="sh1"></div>
    	<div class="sh2"></div>
    	<h1 class="lt"><?php esc_html_e( 'loading',  'webinar-education' ); ?></h1>
    </div>
<?php endif; ?>
			...
			<div class="row">
				<div class="col-lg-7 col-md-4 align-self-center text-md-left text-center">
					<?php if ( get_theme_mod('lms_education_phone_number') ) : ?>
				    	<span class="mr-3"><span class="dashicons dashicons-<?php echo esc_attr( $webinar_education_icon1 ); ?>"></span><a href="callto:<?php echo esc_html(get_theme_mod('lms_education_phone_number','')); ?>"><?php echo esc_html(get_theme_mod('lms_education_phone_number','')); ?></a></span>
				  	<?php endif; ?>
				  	<?php if ( get_theme_mod('lms_education_email_address') ) : ?>
				    	<span><span class="dashicons dashicons-<?php echo esc_attr( $webinar_education_icon2 ); ?>"></span><a href="mailto:<?php echo esc_html(get_theme_mod('lms_education_email_address','')); ?>"><?php echo esc_html(get_theme_mod('lms_education_email_address','')); ?></a></span>
				  	<?php endif; ?>
				</div>
